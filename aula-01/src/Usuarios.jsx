        ...
        <div className='container'>
            <div>
                ...
                <form action="CadastroUsuario">
                    ...
                    <input type="email" placeholder="seuemail@google.com" /><br /><br />
                    ...
                    <input type="password" placeholder="Digite sua senha" /><br /><br /><br /><br />

                    <input type="button" value="Salvar" /><br /><br /><br />
